# Generated by Django 4.2.9 on 2025-07-03 18:44
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('uso_medio_diario_horas', models.DecimalField(blank=True, decimal_places=2, max_digits=5, null=True, verbose_name='Uso Médio Diário (horas)')),
        ...
        migrations.AddField(
            ...
            name='default_tariff',
            field=models.ForeignKey(blank=True, help_text='Tarifa padrão associada a este perfil.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='profiles_with_default_tariff', to='pages.energytariff'),
        ),
        migrations.AddField(
            model_name='energyprofiles',
            name='user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='energy_profiles', to=settings.AUTH_USER_MODEL),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('alert_type', models.CharField(choices=[('high_consumption', 'Consumo Elevado'), ('goal_exceeded', 'Meta Excedida'), ('model_accuracy_low', 'Acurácia do Modelo Baixa'), ('system_error', 'Erro do Sistema'), ('information', 'Informação'), ('CONSUMPTION_EXCEEDED', 'Consumo Excedido'), ('GOAL_THRESHOLD_REACHED', 'Limite de Meta Atingido'), ('BILL_OVERDUE', 'Fatura Vencida'), ('PREDICTION_DEVIATION', 'Desvio de Previsão'), ('QUALITY_ISSUE', 'Problema de Qualidade de Energia')], default='information', max_length=50)),
